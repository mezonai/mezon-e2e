...
export class MessagePage {
  ...
  constructor(page: Page) {
    ...
    this.topicMessages = page.locator(
      `${generateE2eSelector('discussion.box.topic')} ${generateE2eSelector('chat.direct_message.message.item')}`
    );
    this.topicInput = page.locator(
      `${generateE2eSelector('discussion.box.topic')} ${generateE2eSelector('mention.input')}`
    );
    this.threadMessages = page.locator(
      `${generateE2eSelector('discussion.box.thread')} ${generateE2eSelector('chat.direct_message.message.item')}`
    );
    this.threadInput = page.locator(
