...
export class MessgaePage {
    ...
    constructor(page: Page) {
        ...
        this.group = page.locator('div.dm-wrap').filter({ has: page.locator('span.one-line', { hasText: /,/ }) }).first();
    ...
    async isGroupCreated(prevGroupCount: number): Promise<boolean> {
        ...
        const groupNames = await this.page.locator('p.text-xl.md\\:text-3xl.font-bold.pt-1.text-theme-primary-active').allTextContents();
