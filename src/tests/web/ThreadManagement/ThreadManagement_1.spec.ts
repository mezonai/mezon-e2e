...
const THREAD_CREATION_TAG = 'thread-creation';
const PRIVATE_CHANNEL_TAG = 'private-channel';
...
test.describe('Thread in Private Channel', () => {
  ...
  test('Verify that I can create a new public thread in a private channel', async ({ page }) => {
    ...
    await AllureReporter.addLabels({
      tag: [THREAD_CREATION_TAG, 'public-thread', PRIVATE_CHANNEL_TAG],
    });
  ...
  test('Verify that I can create a new private thread in a private channel', async ({ page }) => {
    ...
    await AllureReporter.addLabels({
      tag: [THREAD_CREATION_TAG, 'private-thread', PRIVATE_CHANNEL_TAG],
    });
  ...
  test('Verify that I can delete a thread in a private channel', async ({ page }) => {
    ...
    `);
    await AllureReporter.addLabels({
      tag: ['thread-deletion', PRIVATE_CHANNEL_TAG],
    });
...
test.describe('Thread in Public Channel', () => {
  ...
  test('Verify that I can create a new public thread in a public channel', async ({ page }) => {
    ...
    await AllureReporter.addLabels({
      tag: [THREAD_CREATION_TAG, 'public-thread', 'public-channel'],
    });
  ...
  test('Verify that I can create a new private thread in a public channel', async ({ page }) => {
    ...
    await AllureReporter.addLabels({
      tag: [THREAD_CREATION_TAG, 'private-thread', 'public-channel'],
    });
