...
test.describe('Channel Message 7', () => {
  ...
  `);
    ...
    await AllureReporter.step('Cleanup relationship', async () => {
    ...
    await AllureReporter.step('User A sends friend request', async () => {
    ...
    await AllureReporter.step('Verify friendship', async () => {
