...
import { BLOCK_USER_STEPS } from './BlockUserTestConstants';
...
test.describe('Blocked Users - Restricted DM Header Actions', () => {
  ...
  test('Should remove call action in DM header after blocking friend', async ({ dual }) => {
    ...
    await test.step(BLOCK_USER_STEPS.openDirectMessage, async () => {
    ...
    await test.step(BLOCK_USER_STEPS.blockFromDirectMessage, async () => {
